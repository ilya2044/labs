...
void selectionSort(float data[], int lenD)
{
    int j = 0;
    int tmp = 0;
    for (int i = 0; i < lenD; i++)
...
void bubbleSort(float data[], int lenD)
{
    int tmp = 0;
    for (int i = 0; i < lenD; i++)
    {
...
void insertionSort(float data[], int lenD)
{
    int key = 0;
    int i = 0;
    for (int j = 1; j < lenD; j++)
...
void merge(float merged[], int lenD, float L[], int lenL, float R[], int lenR)
{
    int i = 0;
    int j = 0;
    while (i < lenL || j < lenR)
...
void mergeSort(float data[], int lenD)
{
    if (lenD > 1)
    {
        int middle = lenD / 2;
...
void quickSort(float *data, int const len)
{
    int const lenD = len;
    int pivot = 0;
    int ind = lenD / 2;
